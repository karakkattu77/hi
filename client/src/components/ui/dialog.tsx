...
>(({ className, ...props }, ref) => ( <DialogPrimitive.Overlay ref={className}={cn( "fixed inset-0 z-50 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className )} {...props} />
))
...
>(({ className, ...props }, ref) => ( <DialogPrimitive.Title ref={className}={cn( "text-lg font-semibold leading-none tracking-tight", className )} {...props} />
))
...
>(({ className, ...props }, ref) => ( <DialogPrimitive.Description ref={className}={cn("text-sm text-muted-foreground", className)} {...props} />
))
