...
>(({ className, ...props }, ref) => ( <h5 ref={className}={cn("mb-1 font-medium leading-none tracking-tight", className)} {...props} />
))
...
>(({ className, ...props }, ref) => ( <div ref={className}={cn("text-sm [&_p]:leading-relaxed", className)} {...props} />
))
